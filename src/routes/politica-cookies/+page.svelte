...
<svelte:head>
  <title>Política de Cookies - UpClinic | clinicupapp.com</title>
  <meta name="description" content="Política de Cookies do UpClinic. Saiba como utilizamos cookies em nosso site." />
  <link rel="canonical" href="https://clinicupapp.com/politica-cookies" />
</svelte:head>

<Navbar />

<LegalPageLayout title="Política de Cookies" toc={toc} lastUpdated="26/11/2025">
  <div id="o-que-sao">
    ...
    <p>
      Os cookies permitem que um site reconheça seu dispositivo e armazene algumas informações sobre 
  ...
  <div id="tipos">
    ...
    <p>
      ...
      suas preferências de privacidade, fazer login ou preencher formulários.
    </p>
  ...
  <div id="gerenciar">
    ...
    <h3>3.1. Configurações do Navegador</h3>
    ...
    <h3>3.2. Impacto da Desativação</h3>
    <p>
      Se você desativar os cookies, algumas funcionalidades do site podem não funcionar corretamente. 
      Por exemplo, você pode não conseguir fazer login ou usar certas áreas do site.
    </p>
  </div>
  ...
  <div id="terceiros">
    ...
    <p>
      Além de nossos próprios cookies, também podemos usar vários cookies de terceiros para relatar 
      estatísticas de uso do site, entregar anúncios e assim por diante.
    </p>
    
    <h3>4.1. Serviços de Terceiros</h3>
    <p>Utilizamos os seguintes serviços de terceiros que podem definir cookies:</p>
    <ul>
      <li><strong>Google Analytics:</strong> Para análise de uso do site</li>
      <li><strong>Google Fonts:</strong> Para carregamento de fontes</li>
    </ul>
    
    <p>
      Estes serviços têm suas próprias políticas de privacidade e cookies. Recomendamos que você 
      revise essas políticas para entender como esses serviços tratam seus dados.
    </p>
  </div>
  
  <div class="mt-12 p-6 bg-blue-50 rounded-lg">
    <h3 class="text-xl font-bold text-gray-900 mb-3">Dúvidas sobre Cookies?</h3>
